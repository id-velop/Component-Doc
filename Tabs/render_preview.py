# -*- coding: utf-8 -*-
"""生成 Tabs-preview-baked.html。依赖: pip install markdown

轻量预览：同目录 Tabs-preview.html（fetch Tabs.md，需 HTTP 服务）。
"""
import re
import sys
...
MD = DIR / "Tabs.md"
OUT = DIR / "Tabs-preview-baked.html"
