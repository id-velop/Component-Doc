...
function App() {
  ...
  return (
    <Space direction="vertical" style={{ width: '100%' }}>
      <Typography.Text type="secondary">点击下方选择器，展开浮层体验级联选择的基本要素</Typography.Text>
      <Cascader options={options} placeholder="请选择省 / 市 / 区" style={{ width: 300 }} />
    </Space>
  );
}
```
...
function App() {
  ...
  return <Cascader options={options} placeholder="请选择省 / 市 / 区" style={{ width: 300 }} />;
}
```
...
function App() {
  ...
  return (
    <Form labelCol={{ span: 6 }} wrapperCol={{ span: 16 }} style={{ maxWidth: 500 }}>
      <Form.Item label="收货人" name="name" rules={[{ required: true, message: '请输入姓名' }]}>
        <Input placeholder="请输入姓名" />
      </Form.Item>
      <Form.Item label="所在地区" name="area" rules={[{ required: true, message: '请选择地区' }]}>
...
function App() {
  ...
  return (
    <Cascader
      ...
      style={{ width: 380 }}
      defaultValue={[['zhejiang', 'hangzhou', 'xihu'], ['jiangsu', 'nanjing', 'xuanwu']]}
    />
  );
}
```
...
function App() {
  ...
  return (
    <Space direction="vertical" style={{ width: '100%' }}>
      ...
      <Space wrap>
        <span>配送地区：</span>
        <Cascader multiple options={options} placeholder="请选择地区" style={{ width: 320 }} />
  ...
  return (
    <Space size="large">
      <Space direction="vertical">
        <Typography.Text type="secondary">移入展开（hover）</Typography.Text>
        <Cascader expandTrigger="hover" options={options} placeholder="鼠标移入展开" style={{ width: 220 }} />
      </Space>
      <Space direction="vertical">
        <Typography.Text type="secondary">点击展开（click）</Typography.Text>
        <Cascader options={options} placeholder="点击展开" style={{ width: 220 }} />
      </Space>
    </Space>
  );
}
...
function App() {
  ...
  const options = [
    { value: 'zhejiang', label: '浙江', children: [
      ...
      { value: 'wenzhou', label: '温州', children: [
        { value: 'lucheng', label: '鹿城' },
      ]},
    ]},
    { value: 'jiangsu', label: '江苏', children: [
      { value: 'nanjing', label: '南京', children: [
  ...
  return (
    <Space direction="vertical">
      <Typography.Text type="secondary">鼠标移入即可快速浏览各层级，点击完成选择</Typography.Text>
      <Cascader expandTrigger="hover" options={options} placeholder="移入浏览省市区" style={{ width: 300 }} />
    </Space>
  );
}
```
...
function App() {
  ...
  return (
    <Space direction="vertical">
      <Typography.Text type="secondary">点击任意层级即可完成选择，无需选到叶子节点</Typography.Text>
      <Cascader changeOnSelect options={options} placeholder="选择即改变" style={{ width: 300 }} value={value} onChange={setValue} />
      {value && <Typography.Text>已选：{value.join(' / ')}</Typography.Text>}
    </Space>
  );
}
```
...
function App() {
  ...
  return (
    <Form labelCol={{ span: 6 }} wrapperCol={{ span: 16 }} style={{ maxWidth: 480 }}>
      <Typography.Text type="secondary" style={{ display: 'block', marginBottom: 16 }}>配送范围设置：只需选省份即可，不必细化到区县</Typography.Text>
      <Form.Item label="配送范围" name="region">
        <Cascader changeOnSelect options={options} placeholder="选择配送范围" />
      </Form.Item>
      <Form.Item wrapperCol={{ offset: 6 }}>
...
function App() {
  ...
  return <Cascader showSearch options={options} placeholder="输入关键词搜索" style={{ width: 300 }} />;
}
```
...
function App() {
  ...
  return (
    <Space direction="vertical">
      <Typography.Text type="secondary">输入「西湖」快速定位到「浙江 / 杭州 / 西湖」</Typography.Text>
      <Cascader showSearch options={options} placeholder="搜索地区名称" style={{ width: 300 }} />
    </Space>
  );
}
```
...
function App() {
  ...
  const options = [
    ...
    { value: 'clothing', label: '服装', children: [
  ...
  return (
    <div style={{ border: '1px solid #d9d9d9', borderRadius: 8, display: 'inline-block' }}>
...
function App() {
  ...
  const options = [
    ...
    { value: 'food', label: '食品', children: [
      { value: 'snack', label: '零食' },
      { value: 'drink', label: '饮料' },
    ]},
  ];
  return (
    <Layout style={{ minHeight: 240, background: '#fff' }}>
      <Sider width={280} style={{ background: '#fafafa', padding: 16 }}>
        <Typography.Text strong style={{ display: 'block', marginBottom: 8 }}>分类筛选</Typography.Text>
        <Cascader.Panel options={options} />
      </Sider>
      <Content style={{ padding: 24 }}>
        <Typography.Text type="secondary">页面主内容区域</Typography.Text>
      </Content>
    </Layout>
  );
}
...
function App() {
  ...
  return (
    <Space size="large" align="start">
      <Space direction="vertical">
        <Typography.Text strong>基本单选：必须选到叶子节点</Typography.Text>
        <Typography.Text type="secondary">适合精确到末级的场景</Typography.Text>
        <Cascader options={options} placeholder="须选到最末级" style={{ width: 240 }} />
      </Space>
      <Divider type="vertical" style={{ height: 80 }} />
      <Space direction="vertical">
        <Typography.Text strong>选择即改变：任意层级可选</Typography.Text>
        <Typography.Text type="secondary">适合父级本身有意义的场景</Typography.Text>
        <Cascader changeOnSelect options={options} placeholder="可选任意层级" style={{ width: 240 }} />
      </Space>
    </Space>
  );
}
...
function App() {
  ...
  return (
    <Space size="large" align="start">
      <Space direction="vertical">
        <Typography.Text strong>单选：只选一条路径</Typography.Text>
        <Typography.Text type="secondary">单一配送地址选择</Typography.Text>
        <Cascader options={options} placeholder="选择一个地址" style={{ width: 240 }} />
      </Space>
      <Divider type="vertical" style={{ height: 80 }} />
      <Space direction="vertical">
        <Typography.Text strong>多选：同时选多条路径</Typography.Text>
        <Typography.Text type="secondary">多地区筛选场景</Typography.Text>
        <Cascader multiple options={options} placeholder="选择多个地区" style={{ width: 280 }} />
      </Space>
    </Space>
  );
}
...
function App() {
  ...
  return (
    <Space size="large" align="start">
      <Space direction="vertical">
        <Typography.Text strong>带搜索：选项多时快速定位</Typography.Text>
        <Cascader showSearch options={options} placeholder="搜索关键词" style={{ width: 240 }} />
      </Space>
      <Divider type="vertical" style={{ height: 80 }} />
      <Space direction="vertical">
        <Typography.Text strong>面板模式：常驻可见</Typography.Text>
...
function App() {
  ...
  return (
    <Space direction="vertical" style={{ width: '100%' }}>
      <Typography.Text strong>筛选栏</Typography.Text>
      <Space wrap>
        <Input.Search placeholder="搜索关键词" style={{ width: 200 }} />
        <Cascader options={options} placeholder="选择分类" style={{ width: 200 }} />
...
function App() {
  ...
  const options = [
    { value: 'zhejiang', label: '浙江', children: [
      { value: 'hangzhou', label: '杭州', children: [
        { value: 'xihu', label: '西湖' },
        { value: 'shangcheng', label: '上城', disabled: true },
      ]},
      { value: 'ningbo', label: '宁波', disabled: true, children: [
        { value: 'haishu', label: '海曙' },
      ]},
    ]},
    { value: 'jiangsu', label: '江苏', children: [
  ...
  return (
    <Space size="large">
      <Space direction="vertical">
        <Typography.Text type="secondary">部分选项禁用</Typography.Text>
        <Cascader options={options} placeholder="含禁用选项" style={{ width: 240 }} />
      </Space>
      <Space direction="vertical">
        <Typography.Text type="secondary">整体禁用</Typography.Text>
        <Cascader options={options} placeholder="整体禁用" style={{ width: 240 }} disabled defaultValue={['zhejiang', 'hangzhou', 'xihu']} />
      </Space>
    </Space>
  );
}
...
function App() {
  ...
  return (
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      <Card title="① 表单内" size="small">
        <Form layout="inline">
          <Form.Item label="地区"><Cascader options={options} placeholder="选择地区" style={{ width: 180 }} /></Form.Item>
          <Form.Item label="姓名"><Input placeholder="姓名" style={{ width: 120 }} /></Form.Item>
          <Form.Item><Button type="primary">提交</Button></Form.Item>
        </Form>
      </Card>
      <Card title="② 筛选区" size="small">
        <Space wrap>
          <Input.Search placeholder="关键词" style={{ width: 160 }} />
          <Cascader options={options} placeholder="分类" style={{ width: 180 }} />
          <DatePicker placeholder="日期" />
          <Button type="primary">查询</Button>
        </Space>
      </Card>
      <Card title="③ 侧边栏" size="small" bodyStyle={{ padding: 0 }}>
        <Layout style={{ background: '#fff' }}>
          <Sider width={200} style={{ background: '#fafafa', padding: 12 }}>
            <Typography.Text strong>分类</Typography.Text>
            <Cascader options={options} placeholder="选择" style={{ width: '100%', marginTop: 8 }} />
          </Sider>
          <Content style={{ padding: 16 }}>
            <Typography.Text type="secondary">主内容区域</Typography.Text>
          </Content>
        </Layout>
      </Card>
    </Space>
...
function App() {
  ...
  return (
    <Space direction="vertical" style={{ width: '100%' }}>
      <Typography.Text type="secondary">按使用频率排列：关键词 → 分类级联 → 状态 → 时间</Typography.Text>
      <Space wrap>
        <Input.Search placeholder="搜索关键词" style={{ width: 180 }} />
        <Cascader options={options} placeholder="选择分类" style={{ width: 180 }} />
        <Select placeholder="状态" style={{ width: 120 }} options={[{ value: 'active', label: '启用' }, { value: 'inactive', label: '停用' }]} />
        <DatePicker.RangePicker style={{ width: 260 }} />
        <Button type="primary">查询</Button>
        <Button>重置</Button>
      </Space>
...
function App() {
  ...
  const defaultVal = ['zhejiang', 'hangzhou', 'xihu'];
  return (
    <Flex gap={24} wrap>
      <Flex align="center" gap={8}>
        <Typography.Text type="secondary" style={{ whiteSpace: 'nowrap' }}>Outlined（默认）</Typography.Text>
        <Cascader variant="outlined" options={options} defaultValue={defaultVal} style={{ width: 200 }} />
      </Flex>
      <Flex align="center" gap={8}>
        <Typography.Text type="secondary">Filled</Typography.Text>
        <Cascader variant="filled" options={options} defaultValue={defaultVal} style={{ width: 200 }} />
      </Flex>
      <Flex align="center" gap={8}>
        <Typography.Text type="secondary">Borderless</Typography.Text>
        <Cascader variant="borderless" options={options} defaultValue={defaultVal} style={{ width: 200 }} />
      </Flex>
    </Flex>
  );
}
