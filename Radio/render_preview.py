# -*- coding: utf-8 -*-
"""生成 Radio-preview-baked.html（内联全部 demo）。依赖: pip install markdown

轻量预览可用同目录下 Radio-preview.html（fetch Radio.md，需 HTTP 服务）。
"""
import re
import sys
...
MD = DIR / "Radio.md"
OUT = DIR / "Radio-preview-baked.html"
...
<style>
  ...
  .demo-mount {{ margin: 10px 0; padding: 12px 14px; border: 1px solid #e8e8e8; border-radius: 8px; background: #fff; min-height: 48px; max-width: 560px; position: relative; overflow: visible; transform: translate(0); }}
