# -*- coding: utf-8 -*-
"""生成 Splitter-preview-baked.html。依赖: pip install markdown"""
import re
import sys
...
MD = DIR / "Splitter.md"
OUT = DIR / "Splitter-preview-baked.html"
...
<style>
  ...
  .demo-mount {{ margin: 10px 0; padding: 12px 14px; border: 1px solid #e8e8e8; border-radius: 8px; background: #fff; min-height: 48px; max-width: 640px; position: relative; overflow: visible; transform: translate(0); }}
